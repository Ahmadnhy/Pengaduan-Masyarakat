    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto align-items-center">
          ...
          <li class="nav-item">
            <span class="badge px-3 py-2 mr-3 font-weight-bold" style="border-radius: 30px; font-size: 0.75rem; letter-spacing: 0.5px; background-color: rgba(28, 200, 138, 0.1); color: #1cc88a;">PETUGAS</span>
          </li>

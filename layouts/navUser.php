...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASE_PATH; ?>index.php">
      <div class="sidebar-brand-text mx-3 font-weight-bold">WPM</div>
    </a>
    ...
    <li class="nav-item <?php if ($title === "Riwayat Laporan") echo "active"; ?>">
    ...
    <!-- Nav Item - Logout -->
    <li class="nav-item nav-item-logout <?php if ($title === "Logout" || $title === "Login") echo "active"; ?>">
    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto align-items-center">
          ...
          <li class="nav-item">
            <span class="badge px-3 py-2 mr-3 font-weight-bold" style="border-radius: 30px; font-size: 0.75rem; letter-spacing: 0.5px; background-color: rgba(54, 185, 204, 0.1); color: #36b9cc;">WARGA</span>
          </li>
